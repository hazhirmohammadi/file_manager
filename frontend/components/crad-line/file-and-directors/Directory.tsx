...
const Directory = () => {
  const items = [
    ...
    { id: 33, name: "Desk Chair Desk Chair", category: "Furniture", price: 150.0 },
    { id: 44, name: "Smartphone", category: "Electronics", price: 799.99 },
    { id: 55, name: "Headphones", category: "Accessories", price: 199.99 },
    { id: 16, name: "Laptop", category: "Electronics", price: 999.99 },
    { id: 222, name: "Coffee Maker", category: "Home Appliances", price: 49.99 },
    { id: 333, name: "Desk Chair", category: "Furniture", price: 150.0 },
    { id: 4444, name: "Smartphone", category: "Electronics", price: 799.99 },
    { id: 5555, name: "Headphones", category: "Accessories", price: 199.99 },
  ];
  return (
